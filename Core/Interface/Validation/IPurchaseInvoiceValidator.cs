...
namespace Core.Interface.Validation
{
    public interface IPurchaseInvoiceValidator
    {
        ...
        PurchaseInvoice VUpdateObject(PurchaseInvoice pi, IPurchaseInvoiceDetailService _pid, IContactService _cs);
        ...
        bool ValidUpdateObject(PurchaseInvoice pi, IPurchaseInvoiceDetailService _pid, IContactService _c);
