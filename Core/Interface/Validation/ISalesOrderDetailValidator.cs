...
namespace Core.Interface.Validation
{
    public interface ISalesOrderDetailValidator
    {
        ...
        SalesOrderDetail VCreateObject(SalesOrderDetail sod, ISalesOrderDetailService _sods, ISalesOrderService _pos, IItemService _is);
        SalesOrderDetail VUpdateObject(SalesOrderDetail sod, ISalesOrderDetailService _sods, ISalesOrderService _pos, IItemService _is);
        ...
        bool ValidCreateObject(SalesOrderDetail sod, ISalesOrderDetailService _sods, ISalesOrderService _pos, IItemService _is);
        bool ValidUpdateObject(SalesOrderDetail sod, ISalesOrderDetailService _sods, ISalesOrderService _pos, IItemService _is);
